...
public class DBAdapter extends SQLiteOpenHelper {
	...
	private static final String KEY_STUDENT_PROGRAM = "student_program";
	...
	private static final String KEY_ATTENDANCE_SESSION_PROGRAM = "attendance_session_program";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String queryAttendanceSession="CREATE TABLE "+ ATTENDANCE_SESSION_TABLE +" (" +
				...
				KEY_ATTENDANCE_SESSION_PROGRAM + " TEXT, " +
	...
	public void addStudent(StudentBean studentBean) {
		...
		String query = "INSERT INTO student_table (student_firstname,student_lastname,student_mobilenumber,student_address,student_program,student_semester) values ('"+
				...
				studentBean.getStudent_program()+"', '"+
	...
	public ArrayList<StudentBean> getAllStudent()
	{
		...
		if(cursor.moveToFirst()) 
		{
			do{
				...
				studentBean.setStudent_program(cursor.getString(5));
				studentBean.setStudent_semester(cursor.getString(6));
	...
	public ArrayList<StudentBean> getAllStudentByBranchYear(String branch,String year)
	{
		...
		SQLiteDatabase db = this.getWritableDatabase();
		String query = "SELECT * FROM student_table where student_program='"+branch+"' and student_semester='"+year+"'";
		Cursor cursor = db.rawQuery(query, null);
	...
	public int addAttendanceSession(AttendanceSessionBean attendanceSessionBean) {
		...
		String query = "INSERT INTO attendance_session_table (attendance_session_faculty_id,attendance_session_program,attendance_session_semester,attendance_session_date,attendance_session_subject) values ('"+
				attendanceSessionBean.getAttendance_session_faculty_id()+"', '"+
				attendanceSessionBean.getAttendance_session_program()+"','"+
				attendanceSessionBean.getAttendance_session_semester()+"', '"+
	...
	public ArrayList<AttendanceSessionBean> getAllAttendanceSession()
	{
		...
		if(cursor.moveToFirst()) 
		{
			do{
				...
				attendanceSessionBean.setAttendance_session_program(cursor.getString(2));
				attendanceSessionBean.setAttendance_session_semester(cursor.getString(3));
	...
	public ArrayList<AttendanceBean> getAttendanceBySessionID(AttendanceSessionBean attendanceSessionBean)
	{
		...
		String query = "SELECT * FROM attendance_session_table where attendance_session_faculty_id="+attendanceSessionBean.getAttendance_session_faculty_id()+""
				+" AND attendance_session_program='"+attendanceSessionBean.getAttendance_session_program()+"' AND attendance_session_semester='"+attendanceSessionBean.getAttendance_session_semester()+"'" +
